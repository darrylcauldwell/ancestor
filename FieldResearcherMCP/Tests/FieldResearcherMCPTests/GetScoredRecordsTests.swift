        ...
        try q.write { db in
            ...
            try db.execute(sql: """
                CREATE TABLE evidence_records (
                    ...
                    record_json TEXT NOT NULL, citation_full TEXT, citation_url TEXT, scored_at DATETIME NOT NULL, user_status TEXT NOT NULL DEFAULT 'unreviewed', gates_json TEXT, applied_at DATETIME)
                """)
