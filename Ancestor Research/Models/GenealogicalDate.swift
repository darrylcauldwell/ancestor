...
nonisolated struct GenealogicalDate: Codable, Hashable, Sendable {
    let original: String
    let earliest: Int?
    let latest: Int?
    ...
    static func parsePreview(_ input: String) -> DateParseResult {
...
nonisolated enum DateQualifier: String, Codable, Sendable {
    case exact
    case about
    case before
    case after
