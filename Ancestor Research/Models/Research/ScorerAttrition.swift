...
nonisolated struct ScorerAttrition: Sendable, Equatable {

    /// Total records scored — the denominator for every other count.
    let candidatesEntered: Int
