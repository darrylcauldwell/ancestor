...
- **Married-surname temporal bound** (TOP priority — silently fuses two women; ≥4 live hits: Mary Holmes, Thompson reconciler, Mary Thompson, Sarah Gilbert). Married-surname match only for records dated ≥ the marriage; an unmarried child of a same-surname head is a strong negative.
