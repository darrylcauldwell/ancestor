...
protocol AuditRuleDefinition: Sendable {
    var id: String { get }
...
struct LifespanRule: AuditRuleDefinition {
    let id = "lifespan"
...
struct NoMarriageAfterDeathRule: AuditRuleDefinition {
...
struct MissingParentsRule: AuditRuleDefinition {
...
struct MissingBirthDateRule: AuditRuleDefinition {
...
struct MissingDeathDateRule: AuditRuleDefinition {
...
struct MissingBirthLocationRule: AuditRuleDefinition {
...
struct MissingBioRule: AuditRuleDefinition {
    let id = "missingBio"
...
struct DuplicateDetectionRule: AuditRuleDefinition {
