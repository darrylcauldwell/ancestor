...
public nonisolated enum CensusType: String, CaseIterable, Sendable, Identifiable {
    case census1841
    case census1851
    case census1861
    case census1871
    ...
    public nonisolated static func computeBirthYear(censusYear: Int, ageAtCensus: Int) -> Int {
