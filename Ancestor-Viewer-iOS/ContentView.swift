        ...
        Group {
            ...
            case .noAccount:
                StatusScreen(
                    ...
                    message: "This device must be signed into the same iCloud account that publishes the tree from the Mac app. Sign in from Settings, then relaunch.")
            case .notPublished:
                StatusScreen(
                    systemImage: "tree",
                    title: "No published tree yet",
                    message: "Publish your tree from Ancestor Research on the Mac (Publish Tree to iCloud…), then pull to refresh.")
